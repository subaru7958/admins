...
function TrainingSessionCreateModal({ isOpen, onClose, onCreated, initialDate }) {
  ...
  useEffect(() => {
    if (formData.group && selectedSessionId) {
      console.log('Loading subgroups for group:', formData.group, 'session:', selectedSessionId);
      loadSubgroups();
    }
  }, [formData.group, selectedSessionId]);
  ...
  const loadSubgroups = async () => {
    try {
      const teamId = localStorage.getItem('teamId');
      if (!teamId || !selectedSessionId) {
        console.log('Missing teamId or sessionId:', { teamId, selectedSessionId });
        return;
      }
      
      console.log('Fetching subgroups from:', `${API_BASE_URL}/api/subgroups/session/${selectedSessionId}?teamId=${teamId}`);
      
      const res = await fetch(`${API_BASE_URL}/api/subgroups/session/${selectedSessionId}?teamId=${teamId}`, {
        method: 'GET',
        headers: {
    ...
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-lg">
          <h3 className="text-lg font-medium leading-6 text-gray-900 mb-4">Add New Training Session</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-2 p-3 bg-blue-50 rounded-lg border border-blue-200">
                  ...
                  />
                  <label htmlFor="isWeekly" className="text-sm font-medium text-blue-800">
                ...
                <div className="flex items-center gap-2 p-3 bg-green-50 rounded-lg border border-green-200">
                  ...
                  />
                  <label htmlFor="isSpecialDate" className="text-sm font-medium text-green-800">
...
export default TrainingSessionCreateModal;